...
from network_model import interpolation_DLNet
...
def main(args):
    ...
    input_tensors, output_tensors = interpolation_DLNet(model_options)
    ...
    # test_input_tensors, test_output_tensors = interpolation_DLNet(test_model_options) 
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:   
        ...
        for i in xrange(args.max_epoch):            
            ...
            for j in xrange(len(filenames)):
                ...
                while (batch_no+1)*args.batch_size <= len(images):
                    ...
                    feed_dict = {
                        ...
                        input_tensors['interpo_perc_range'] : [0.0, 0.75],
                    })[1]
                    batch_no += 1
            ...
            #             test_input_tensors['interpo_perc_range'] : [0.75, 0.75],
            #         })                    
            #         test_batch_no += 1
